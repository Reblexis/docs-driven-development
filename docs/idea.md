...
- The docs live in `./docs`, clearly separated from everything derived; the root README is at most an entry point.
...
This document is the source of truth for this repository. Everything else in the repo is a derived artifact that exists to satisfy it, and is wrong wherever it disagrees. Changes to what this repo does happen here first.
